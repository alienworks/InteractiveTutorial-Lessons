...
As we have seen in Lesson 1, a contract on the Neo network functions as a list of methods that can be called by others. But further loops and switches will allow us to implement a complex structure in the smart contract.
