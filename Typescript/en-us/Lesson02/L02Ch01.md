...
- Define a `public readonly` property called `owner` in `Address` type in the input area of the constructor, and get the initial value from `Deploy.senderAddress`.