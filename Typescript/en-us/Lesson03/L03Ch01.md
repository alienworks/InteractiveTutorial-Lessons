...
There are three core concepts in DnD games - story, rule set and dice. The story defines the game background and settings. The rule set defines what happends and why, when, where and
how they happen. And the dice decides the result of every event. 
